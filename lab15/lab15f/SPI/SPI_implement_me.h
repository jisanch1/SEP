...
#define wc(DATA) SPI_Master_transmit_char(DATA, true, SS_TFT)
#define wd(DATA) SPI_Master_transmit_char(DATA, false, SS_TFT)
...
void SPI_Master_transmit_char(uint8_t data, bool commandmode, uint8_t ss);

char SPI_Master_receive_char(void);
void SPI_select_ss(uint8_t ss);
